...
import { LatestPropertyDetaill } from "../../../constValues/constValues";
        ...
        <Row>
          <Col>
            <div className="title-3">
              ...
              <p className="font-roboto">{LatestPropertyDetaill}</p>
            </div>
            <NoSsr>
                    ...
                    <div key={i}>
                      <div className="about-content">
                        ...
                        <div className="our-details">
                          ...
                          <Link href="tel:{data.details}" className="btn btn-solid btn-flat mt-2">
                            <Eye />
                            Contact:- {data.name}
                          </Link>
                        </div>
