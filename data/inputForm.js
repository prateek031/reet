export const InputForm = [
  ...
  { name: "propertyType", label: "Property Type", size: "12", options: ["Property Type","LOT", "Commercial Building", "Stores", "Farms","Apartment","Villa","Studio","Investment Projects"] },
...
export const createPropertyInputForms = [
  { name: "propertyType", label: "Property Type", size: "12", options: ["Property Type", "LOT", "Commercial Building", "Stores", "Farms","Apartment","Villa","Studio","Investment Projects"], validation: { required: true } },
